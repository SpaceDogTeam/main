...
class App:
    ...
    def menu(self):
        ...
        self.boutonOnOff = tk.Button(self.FrameBoutons2, 
                                           text="On/Off",
                                           command=self.turnOnOff)
        self.boutonOnOff.place(x=0,y=0)
...
class MyStoppableThread(threading.Thread):
    ...
    def transmit_to_leg(self):
        ...
        self.ser.write(str.encode("%s" %(self.intrfBuffer)))
        self.intrfBuffer = ''
