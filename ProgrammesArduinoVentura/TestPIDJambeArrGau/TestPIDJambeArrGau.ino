...
//-----------------------------------------------------------------------
double theta21[] = {48, 49, 50, 61, 47, 51, 48, 49, 50, 61, 47, 51, 48, 49, 50, 61, 47, 51};
double theta11[] = {156, 143, 130, 143, 156, 156, 143, 130, 143, 156, 156, 143, 130, 143, 156};
...
void speedControl(){
  ...
  if(AJointAng > AJointSetpoint) digitalWrite(AEN_PIN, HIGH);  //  change the direction of the rotation
