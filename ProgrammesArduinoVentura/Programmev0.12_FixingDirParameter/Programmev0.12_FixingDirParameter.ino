...
PID myPIDmotorA(&legsAngles[0],&pwmValue[0],&anglesSetpointsArray[0],100,0,0,r_dir);  //r_dir=1 -> reversed, 0 -> direct
PID myPIDmotorB(&legsAngles[1],&pwmValue[1],&anglesSetpointsArray[1],100,0,0,!r_dir); //the opposite
